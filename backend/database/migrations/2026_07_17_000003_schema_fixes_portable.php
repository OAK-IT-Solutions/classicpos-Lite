...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if ($driver === 'pgsql') {
            ...
            // For SQLite/MySQL, check via Schema::hasColumns or just attempt
            $fkExists = false;
        }
        ...
        // SQLite: All constraints are handled by Laravel's Schema builder
        // MySQL: CHECK constraints are supported since MySQL 8.0.16
    }
